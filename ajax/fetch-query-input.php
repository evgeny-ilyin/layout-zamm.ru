...
try {
	...
	switch ($_REQUEST['block']) {
		...
		case 'query':
			$content = '
					<div class="js-write" data-value="location-0" data-target="order[ORDER_PROP_4]">Ул. Новый Арбат, дом 2</div>
					<div class="js-write" data-value="location-1" data-target="order[ORDER_PROP_4]">Ул. Новый Арбат, дом 20</div>
					<div class="js-write" data-value="location-2" data-target="order[ORDER_PROP_4]">Ул. Новый Арбат, дом 21</div>
					<div class="js-write" data-value="location-3" data-target="order[ORDER_PROP_4]">Ул. Новый Арбат, дом 22</div>
					<div class="js-write" data-value="location-4" data-target="order[ORDER_PROP_4]">Ул. Новый Арбат, дом 23</div>
					<div class="js-write" data-value="location-5" data-target="order[ORDER_PROP_4]">Ул. Новый Арбат, дом 24</div>';
